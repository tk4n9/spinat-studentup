...
export function useVideoRecorder() {
  ...
  const startRecording = useCallback(async (format: Format) => {
    ...
    recorder.onstop = async () => {
      ...
      // Fix missing duration metadata so seek bar works in review player
  ...
  return { previewStream, recordedBlob, isRecording, error, initCamera, startRecording, stopRecording, cleanup };
}
